...
func readInput() {
	...
	for s.Scan() {
		...
		msgchan <-m
    	//fmt.Println(msg)// TODO: Send the message to the channel of messages.
	}
...
func dial(addr string) {
	...
	for m := range msgchan/* TODO: Receive messages from the channel using range, storing them in the variable m. */ {
